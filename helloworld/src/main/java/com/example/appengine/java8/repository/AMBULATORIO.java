...
public class AMBULATORIO {
    ...
    public AMBULATORIO withBIANCO(int bIANCO) {
        this.bIANCO = bIANCO;
        return this;
    }
    ...
    public AMBULATORIO withGIALLO(int gIALLO) {
        this.gIALLO = gIALLO;
        return this;
    }
    ...
    public AMBULATORIO withROSSO(int rOSSO) {
        this.rOSSO = rOSSO;
        return this;
    }
    ...
    public AMBULATORIO withVERDE(int vERDE) {
        this.vERDE = vERDE;
        return this;
    }
