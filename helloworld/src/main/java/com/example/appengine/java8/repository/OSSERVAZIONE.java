...
public class OSSERVAZIONE {
    ...
    public OSSERVAZIONE withBIANCO(int bIANCO) {
        this.bIANCO = bIANCO;
        return this;
    }
    ...
    public OSSERVAZIONE withGIALLO(int gIALLO) {
        this.gIALLO = gIALLO;
        return this;
    }
    ...
    public OSSERVAZIONE withROSSO(int rOSSO) {
        this.rOSSO = rOSSO;
        return this;
    }
    ...
    public OSSERVAZIONE withVERDE(int vERDE) {
        this.vERDE = vERDE;
        return this;
    }
